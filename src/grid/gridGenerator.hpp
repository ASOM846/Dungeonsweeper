...
private:
	...
	void OnRevealedClick(int x, int y, Grid &grid, int &hp);
	...
	void UncoverStartingCellNeighbors(int x, int y, std::array<std::array<Grid::Cell, Grid::WIDTH>, Grid::HEIGHT> &cells);
